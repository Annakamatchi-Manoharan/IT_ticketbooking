        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveTicketCount = table.Column<int>(type: "int", nullable: false),
                    ...
                    IsSeniorAgent = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredictedCategory = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    BotResponse = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EngineerChatHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EngineerChatHistories_Users_EngineerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamViewerId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    TeamViewerPasswordProtected = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RequesterPhone = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    ...
                    EscalationProcessed = table.Column<bool>(type: "bit", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    SearchedIssue = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserChatHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserChatHistories_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EngineerChatHistories_EngineerId_CreatedAt",
                table: "EngineerChatHistories",
                columns: new[] { "EngineerId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_IsOverdue_EscalationProcessed_Status",
                table: "Tickets",
                columns: new[] { "IsOverdue", "EscalationProcessed", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_QueueStatus_AssignedAgentId_Status",
                table: "Tickets",
                columns: new[] { "QueueStatus", "AssignedAgentId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserChatHistories_UserId_CreatedAt",
